    ...
    <div className="relative">
      <div className="bg-surface rounded-2xl p-6 border border-border shadow-xl">
        ...
        <button
          ...
          className="w-full py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-[1.02] shadow-lg bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-tertiary text-background"
        >
          Enroll Now
        </button>
