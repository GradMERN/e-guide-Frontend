    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center text-text overflow-hidden px-6">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto mt-16">
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-8 drop-shadow-lg bg-linear-to-r from-(--gradient-from) via-(--gradient-via) to-(--gradient-to) bg-clip-text text-transparent"
        >
          About Us
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-text-secondary leading-relaxed drop-shadow mb-4"
        >
        ...
        <motion.p
          ...
          className="text-shadow-text-secondary md:text-lg leading-relaxed mb-6"
        >
      ...
      >
        <ChevronDown
          size={28}
          className=" drop-shadow-[0_0_8px_rgba(231,205,141,0.8)] md:w-8 md:h-8 lg:w-8 lg:h-8"
        />
      </motion.button>
    </section>
  );
