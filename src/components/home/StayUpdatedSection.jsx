      ...
      <div className="min-h-screen py-6 sm:py-6 px-4 md:px-8 lg:px-12">
        <div className="text-center mb-10 sm:mb-12 lg:mb-16">
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="relative mx-4">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-[linear-gradient(to_bottom_right,#FFD97F,#FFE6A0)] flex items-center justify-center shadow-lg shadow-[#FFD97F]/30 rounded-lg">
                <GrUpdate className="w-6 h-6 sm:w-7 sm:h-7 text-black" />
              </div>
              <GrUpdate className="absolute top-0 left-0 w-12 h-12 sm:w-14 sm:h-14 opacity-30 blur-sm text-[#FFD97F]" />
            </div>
          ...
          <p className="text-sm sm:text-lg text-white max-w-3xl mx-auto px-2">
            Subscribe to the latest news, travel insights, and special offers to
            make the most of your journey through Egypt. Never miss an update
            that could inspire your next adventure.
          </p>
        </div>
      </div>
    </section>
