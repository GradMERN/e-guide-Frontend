  ...
  return (
    <div className="text-center mb-10 sm:mb-12 lg:mb-16">
      <div className="flex items-center justify-center mb-6">
        <div className="h-1 w-32 sm:w-48 md:w-64 bg-[linear-gradient(to_right,#C7A15C,#FFE6A0,#FFD27F,transparent)]"></div>
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 drop-shadow-lg bg-linear-to-r from-[#C7A15C] via-[#FFE6A0] to-[#FFD27F] bg-clip-text text-transparent leading-normal">
        {title}
      </h2>
