export default function TitlesHome({ icon: Icon, title, paragraph }) {
  return (
    <div className="text-center mb-8 sm:mb-10 md:mb-12 px-2 sm:px-4">
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-3 bg-[linear-gradient(to_right,var(--gradient-from),var(--gradient-via),var(--gradient-to))] bg-clip-text text-transparent leading-snug sm:leading-snug md:leading-snug">
        {title}
      </h2>
