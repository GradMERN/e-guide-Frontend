...
const TourCard = ({ tour }) => {
  return (
    <Link to={`/tours/${tour._id}`} className="group">
      <div
        className="relative h-full backdrop-blur-xl bg-white/5 rounded-2xl overflow-hidden border border-white/10 hover:shadow-2xl transition-all duration-500 group-hover:transform group-hover:scale-[1.02]"
        style={{
      ...
      >
        {/* Image Container */}
        <div className="relative h-56 bg-gradient-to-br from-[#FFE6A0]/40 via-[#FFD670]/30 to-[#FFC940]/40 overflow-hidden">
          ...
          {/* Rating Badge */}
          <div
            className="absolute top-3 right-3 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/60 backdrop-blur-sm"
            style={{
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-white/10">
            <div>
              ...
              <p className="text-2xl font-bold bg-gradient-to-r from-[#FFE6A0] to-[#FFD670] bg-clip-text text-transparent">
                {tour.price}
