    ...
    return (
      <div className="min-h-screen relative overflow-hidden transition-colors duration-500 pt-20 px-4 sm:px-6 bg-background text-text w-full max-w-[100vw]">
        ...
        <div className="max-w-4xl mx-auto relative z-10 pb-20">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-(--surface) rounded-xl shadow-xl p-6 md:p-8 border border-(--border)">
