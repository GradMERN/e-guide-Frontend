      ...
      <div className="max-w-4xl mx-auto">
        {fetchLoading ? (
          ...
          <>
            ...
            {/* Settings Card */}
            <div
              className={`${cardBg} rounded-xl border ${borderColor} p-8 shadow-lg`}
            >
                ...
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className={`text-xs ${secondaryText} mt-2`}>
                      {t("guide.settings.emailReadOnly") ||
            ...
            {/* Info Section */}
            <div
              className={`${cardBg} rounded-xl border ${borderColor} p-6 mt-8`}
            >
              ...
              <div className={`space-y-2 ${secondaryText} text-sm`}>
                <p>
                  • {t("guide.settings.joinDate") || "Member since"}:{" "}
                  {new Date().toLocaleDateString()}
                </p>
                <p>• {t("guide.settings.accountStatus") || "Status"}: Active</p>
                <p>
                  •{" "}
                  {t("guide.settings.verificationStatus") ||
                    "Email Verification"}
                  : Verified
                </p>
              </div>
