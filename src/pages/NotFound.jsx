...
export default function NotFound() {
  ...
  return (
    <div dir="ltr" className="relative min-h-screen w-full overflow-hidden bg-(--background)">
      ...
      <div className="fixed top-8 md:top-12 lg:top-8 right-8 md:right-12 lg:right-42 z-50 flex items-center gap-3 md:gap-4">
        <div><ThemeToggle /></div>
        <div><Switch /></div>
      </div>
      
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center lg:justify-center min-h-screen px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 gap-6 sm:gap-8 lg:gap-12 py-8 sm:py-10 lg:py-12 md:pt-24 max-w-7xl mx-auto">
