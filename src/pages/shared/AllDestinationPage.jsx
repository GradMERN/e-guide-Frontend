...
export default function AllDestinationPage() {
  ...
  const destinations = [
    {
      ...
      description:
        "The sprawling capital, home to Giza Pyramids, Khan el-Khalili, and endless history.",
      image:
    ...
    },
    {
      ...
      description:
        "The ancient city of Thebes, featuring Karnak, Luxor Temple, and the Valley of the Kings.",
    ...
    },
    {
      ...
      description:
        "A serene Nile city famous for Philea Temple, the High Dam, and colorful Nubian villages.",
      image:
    ...
    },
    {
      ...
      description:
        "The iconic site of the Sphinx and the Great Pyramids, a testament to ancient engineering.",
      image:
    ...
    },
    {
      ...
      description:
        "Rich in pharaonic history, featuring Tel El Amarna and Beni Hasan tombs.",
      image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Beni_Hassan_tomb_entrance.jpg/800px-Beni_Hassan_tomb_entrance.jpg",
    ...
    },
    {
      ...
      description:
        "Famous for the Red and White Monasteries and the temple of Abydos.",
      image:
        "https://images.unsplash.com/photo-1669222666710-1418837265a0?w=800",
    ...
    },
    {
      ...
      description:
        "Home to the magnificent Dendera Temple complex dedicated to Hathor.",
      image:
        "https://images.unsplash.com/photo-1637703310029-7945c719542e?w=800",
    ...
    },
    {
      ...
      description:
        "Known for the collapsed pyramid of Meidum and proximity to Fayoum.",
      image:
        "https://upload.wikimedia.org/wikipedia/commons/e/e0/Meidum_Pyramid.jpg",
    ...
    },
    {
      ...
      description:
        "A major agricultural and trade hub with ancient monasteries.",
      image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Assiut_Barrage.jpg/800px-Assiut_Barrage.jpg",
    ...
    },
    {
      ...
      description:
        "Discover coastal charm, ancient libraries, and Roman amphitheaters.",
      image:
    ...
    },
    {
      ...
      description:
        "Crystal clear waters and white sandy beaches on the north coast.",
      image:
        "https://images.unsplash.com/photo-1626278854823-3b473da5743a?w=800",
    ...
    },
    {
      ...
      description:
        "A cosmopolitan city at the northern entrance of the Suez Canal.",
      image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Port_Said_Lighthouse.jpg/800px-Port_Said_Lighthouse.jpg",
    ...
    },
    {
      ...
      description:
        "Famous for Ras El Bar resort and high-quality furniture and sweets.",
      image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Ras_El_Bar_Lighthouse.jpg/800px-Ras_El_Bar_Lighthouse.jpg",
    ...
    },
    {
      ...
      description:
        "Dive into crystal-clear waters, vibrant coral reefs, and endless resorts.",
    ...
    },
    {
      ...
      description:
        "World-class diving, luxury resorts, and vibrant nightlife in Sinai.",
    ...
    },
    {
      ...
      description:
        "A laid-back beach town famous for the Blue Hole and windsurfing.",
      image:
        "https://images.unsplash.com/photo-1682687220509-61b8a906ca19?w=800",
    ...
    },
    {
      ...
      description:
        "Pristine reefs, sea turtles, and dugongs in a quiet setting.",
      image:
    ...
    },
    {
      ...
      description:
        "Luxury resorts overlooking the Gulf of Aqaba and three countries.",
      image:
        "https://images.unsplash.com/photo-1582234032127-14e36511470e?w=800",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1600520623254-20d36750307c?w=800",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1517411032315-54ef2cb003ac?w=800",
    ...
    },
    {
      ...
      description:
        "Surreal chalk rock formations in the White Desert National Park.",
    ...
    },
    {
      ...
      description:
        "Green landscapes and colonial architecture along the Suez Canal.",
      image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Suez_Canal_Ismailia.jpg/800px-Suez_Canal_Ismailia.jpg",
    ...
    },
    {
      ...
      image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Suez_Port_Tewfik.jpg/800px-Suez_Port_Tewfik.jpg",
  ...
  return (
    <div className="relative text-text overflow-hidden bg-background w-full mt-10">
